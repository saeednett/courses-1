    ...
    $("select[name=bank]").on('change', function () {
        ...
        $.ajax({
            ...
            success: function (data, result) {
                ...
                $(".account-information").append(" <div class='row justify-content-center'> <div class='col-lg-8'> <img src='" + data['response']['logo'] + "' class='d-block ml-auto w-100 h-100' alt='Bank Logo'> </div> </div> <div class='row justify-content-center mt-4'> <div class='col-lg-8 text-right'> <p class='mb-0 rtl'> البنك : " + data['response']['name'] + " </p></div> </div> <div class='row justify-content-center mt-0'> <div class='col-lg-8 text-right'> <p class='m-0 rtl'> اسم الحساب : " + data['response']['account_owner'] + " </p> </div> </div> <div class='row justify-content-center mt-0'> <div class='col-lg-8 text-right'> <p class='m-0 rtl'>  رقم الحساب : " + data['response']['account_number'] + " </p> </div> </div> <div class='row justify-content-center mt-0'> <div class='col-lg-8 text-right'>  <p class='m-0 rtl'>  رقم الايبان : " + data['response']['account_number'] + " </p> </div> </div> ");
            },
            error: function () {
