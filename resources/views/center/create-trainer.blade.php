                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           name="phone" id="phone" value="{{ old('phone') }}" placeholder="رقم هاتف المدرب" minlength="9" maxlength="13" autocomplete="off" required>
                                    @if ($errors->has('phone'))
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="email"
                                           ...
                                           name="email" id="email" value="{{ old('email') }}" placeholder="البريد الإلكتروني للمدرب" autocomplete="off" required>
                                    @if ($errors->has('email'))
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           name="username" id="username" value="{{ old('username') }}" placeholder="اسم المستخدم للمدرب" minlength="5" maxlength="20" autocomplete="off" required>
