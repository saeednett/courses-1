    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.add-account', function () {
                $('#accounts').append("<div class='row form-group' id='new-row'> <div class='col-lg-5'> <label class='col-form-label required-field' for='account_owner_" + counter + "' >اسم صاحب الحساب</label> <input type='account_owner' id='account_owner_" + counter + "' class='form-control custom-input' name='account_owner[]' placeholder='اسم صاحب الحساب' required> </div> </div>");
                $('#new-row').append("<div class='col-lg-3'> <label class='col-form-label required-field' for='account_number_" + counter + "' >رقم الحساب</label> <input type='text' id='account_number_" + counter + "' class='form-control custom-input' name='account_number[]' placeholder='رقم الحساب' required> </div>");
                ...
                for (let i = 0; i < $('#main-bank').children().length; i++){
                    ...
                    $('#new-account').append("<option>"+text+"</option>");
                }
                                ...
                                <div class="row form-group">
                                    @foreach($accounts as $account)
                                        ...
                                        @if($counter == 1)
                                            ...
                                            <div class="col-lg-3">
                                                <label class="col-form-label required-field" for="main-bank">البنك</label>
                                                <select id="main-bank" class="form-control {{ $errors->has('bank') ? 'is-invalid' : '' }} custom-input"
                                                        name="bank[]" required>
                                            ...
                                            <div class="col-xl-1 col-lg-1 col-md-12 col-sm-12 col-xs-4 col-lg-offset-0 col-xs-offset-4 text-center">
                                                ...
                                                <span class="btn-success text-center icon-plus add-account"></span>
                                            </div>
                                            <?php $counter++; ?>
                                        @else
                                            <div class="col-lg-5">
                                                ...
                                                <input type="account_owner" id="account_owner"
                                                       class="form-control custom-input"
                                                       name="account_owner[]" placeholder="اسم صاحب الحساب">
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <label class="col-form-label required-field" for="account_number">رقم
                                                    الحساب</label>
                                                <input type="text" id="account_number" class="form-control custom-input"
                                                       name="account_number[]" placeholder="رقم الحساب">
                                            </div>

                                            <div class="col-lg-3">
                                                <label class="col-form-label required-field" for="bank">البنك</label>
                                                <input type="text" id="bank" class="form-control custom-input"
                                                       name="account_owner[]" placeholder="البنك">
                                            </div>

                                            <div class="col-lg-1 text-center">
                                                <label class="col-form-label opacity-0" for="bank">المزيد</label>
                                                <span class="btn-danger text-center icon-plus remove-account"></span>
                                            </div>
                                        @endif
                                    @endforeach
                                </div>
