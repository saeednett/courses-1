...
@section('style-file')
    <link rel="stylesheet" href="{{ asset('css/administrator/show-centers-for-reset-email.css') }}">
@endsection
                            ...
                            @if(count($centers) > 0)
                                @foreach($centers as $center)
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <a href="{{ route('administrator.center.reset.email.edit', $center->user->username) }}">إعادة تعيين</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
