...
@section('title', 'تفعيل الدورات العامة')

@section('style-file')
    <link rel="stylesheet" href="{{ asset('css/administrator/confirm-public-courses.css') }}">
@endsection
        ...
        <div class="col-lg-12 animatedParent animateOnce z-index-50">
            <div class="panel panel-default animated fadeInUp">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title">تفعيل  الدورات العامة</h3>
...
@section('script-file')
    ...
    <script src="{{ asset('js/administrator/confirm-public-courses.js') }}"></script>
@endsection