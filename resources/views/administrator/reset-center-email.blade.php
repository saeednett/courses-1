            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <p class="text-danger">عند تغير البريد الإلكتروني للجهة، المستخدم سوف يكون قادر على تغير كلمة المرور</p>
                    </div>
        ...
        <div class="col-lg-12 animatedParent animateOnce z-index-50">
            <div class="panel panel-default animated fadeInUp">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title">إعادة تعيين بريد إستعادة كلمة المرور للجهات</h3>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <div class="container-fluid">
                            <form method="post" action="{{ route('administrator.center.reset.email.update', $center->username) }}" id="reset-email-form">
                                {{ csrf_field() }}
                                ...
                                <div class="row form-group">
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        ...
                                        <input type="email" id="old_email"
                                               ...
                                               name="old_email" value="{{ $center->email }}"
