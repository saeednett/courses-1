...
@section('style-file')
    <link rel="stylesheet" href="{{ asset('css/administrator/reset-center-email.css') }}" />
    <link rel="stylesheet" href="{{ asset('css/administrator/reset-admin-email.css') }}" />
@endsection
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <p class="text-danger">عند تغير البريد الإلكتروني للمسؤول، المستخدم سوف يكون قادر على تغير كلمة المرور</p>
                    </div>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <div class="container-fluid">
                            <form method="post" action="{{ route('administrator.admin.reset.email.update', $admin->username) }}" id="reset-email-form">
                                {{ csrf_field() }}
                                ...
                                <div class="row form-group">
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        ...
                                        <input type="email" id="old_email"
                                               ...
                                               name="old_email" value="{{ $admin->email }}"
...
@section('script-file')
    <script src="{{ asset('js/administrator/reset-admin-email.js') }}"></script>
@endsection