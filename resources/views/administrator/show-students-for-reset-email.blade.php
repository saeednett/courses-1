        ...
        <div class="col-lg-12 animatedParent animateOnce z-index-50">
            <div class="panel panel-default animated fadeInUp">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title">إعادة تعيين معلومات إستعادة كلمة المرور للطلاب</h3>
                            ...
                            @if(count($students) > 0)
                                @foreach($students as $student)
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <a href="{{ route('administrator.student.reset.email.edit', $student->user->username) }}">إعادة تعيين</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
