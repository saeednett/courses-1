@extends('administrator.layouts.course-preview-master')

@section('title', $course->title)

@section('style-file')
    <link rel="stylesheet" href="{{ asset('css/administrator/course-preview.css') }}" />
@endsection

@section('script-file')
    <script src="{{ asset('js/administrator/course-preview.js') }}"></script>
@endsection
