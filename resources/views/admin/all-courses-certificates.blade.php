                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            @foreach($courses as $admin)
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <a href="{{ route('admin.courses.certificate.students', $admin->course->identifier) }}">إصدار
                                            الشهادات</a>
                                    </td>

                                    <td>
                                        <a href="{{ route('admin.courses.certificate.show', $admin->course->identifier) }}">عرض
                                            الشهادات</a>
                                    </td>
