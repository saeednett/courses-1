            ...
            <div class="col-lg-10">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7 col-md-12 col-sm-12 col-12 text-right order-lg-last order-first mb-lg-4 mt-lg-0 mb-0 mt-4">
                        <h3>{{ $reservation->course->title }}</h3>
                        <div class="main-info">
                                ...
                                <div class="row">
                                    <div class="col-lg-9 col-md-8 col-sm-8 col-8">
                                        <h5 class="text-right d-lg-block d-none rtl"><span>اسم المنظم:</span> <a
                                                    href="{{ route('student.center.profile.show', $reservation->course->center->user->username) }}">{{ $reservation->course->center->name }}</a>
                                        </h5>
                                        <h5 class="text-right d-lg-none d-block rtl"><a
                                                    href="{{ route('student.center.profile.show', $reservation->course->center->user->username) }}">{{ $reservation->course->center->user->name }}</a>
                                        </h5>
                            ...
                            <div class="block rounded">
                                ...
                                <div class="row info">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-8 rtl">
                                        @if($reservation->course->gender == 1)
                                            رجال فقط
                                        @elseif($reservation->course->gender == 2)
                                            نساء فقط
                                        @else
                                            رجال ونساء
                                        @endif
                                ...
                                <div class="row info">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8 col-8 rtl">
                                        ...
                                        @else
                                            {{ date('h:i', strtotime($reservation->course->start_time)).' صباحا' }}
                                        @endif
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <h4 class="text-right pr-2">بطاقة الحضور</h4>
                            </div>

                            <div class="col-12">

                                <div class="block rounded-bottom mt-0 pb-0 rtl">


                                    <?php
                                    use Endroid\QrCode\QrCode;
                                        $qrCode = new QrCode($reservation->barcode);
                                        $qrCode->setSize(100); // مقاس الباركود
                                        $qrCode->setMargin(10); // إضافة مسافات في جوانب الباركو
                                    ?>
                                    ...
                                    <div class="barcode-holder">
                                        <div class="row justify-content-start">
                                            ...
                                            <div class="col-12 p-2">
                                                <a href="{{ $qrCode->writeDataUri() }}" download>
                                                    <img src="{{ $qrCode->writeDataUri() }}" class="img-thumbnail" id="barcode"
                                                         align="Course Ticket Barcode">
                                                </a>
                                            </div>
                                    ...
                                    <div class="row justify-content-center border-top mt-2 pr-0">
                                        <div class="col text-center border-left show-ticket p-1"><a href="">عرض</a></div>
                                        <div class="col text-center download-ticket p-1"><a href="{{ $qrCode->writeDataUri() }}" download>تنزيل</a> </div>
                                    </div>
                                </div>
